    ...
    def substitute_atoms(self, atoms, symbol_of_elements, isUpdatedInfo=False, isPersist=False, **kwargs):
        ...
        for i in range(0, len(atoms)):
            ...
            if isinstance(symbol_of_elements, str):
                ...
                structure.substitute_atom(atom=structure.get_atom(formated_atom=formated_atom), symbol_of_element_or_species=symbol_of_element)
...
# =========================================================================
        if not isinstance(operator_matrix, np.ndarray): operator_matrix=np.array(operator_matrix)
...
# =========================================================================
                        ...
                        if is_inside(position=p, selective_range=[[0, 1], [0, 1], [0, 1]]):
    ...
    def surface(self, hkl, maxindex=None, saxis='c', isPersist=False, **kwargs):
        ...
        def vect_angle(vect1, vect2, unit='degree'):
            ...
            cosine = np.dot(vect1, vect2)/np.linalg.norm(vect1)/np.linalg.norm(vect2)
